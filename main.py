...
def answer():
    ...
    for key, hostedgame in enumerate(hosted):
        ...
        if hostedgamecheck == game:
            hostedindex = key
            player = hosted[hostedindex]

    if not hostedindex == "Unknown":
        if request.form["choice"] == question["correct"]:
            player["players"][int(request.form["user"])]["upgrades"][2] += player["players"][int(request.form["user"])][
                                                                               "upgrades"][0] * player["players"][int(
                                                                                request.form["user"])]["upgrades"][1]
            hosted[hostedindex] = player
            ...
            player["players"][int(request.form["user"])]["upgrades"][2] -= player["players"][int(request.form["user"])][
                                                                               "upgrades"][0] * player["players"][
                int(request.form["user"])]["upgrades"][1]
            hosted[hostedindex] = player
...
def upgradevalue():
    upgrade = hosted[int(request.form["hostedindex"])]
    upgrade["players"][int(request.form["user"])]["upgrades"][2] -= upgrade["players"][int(request.form["user"])][
                                                                        "upgrades"][int(request.form["item"])] ** 2
    upgrade["players"][int(request.form["user"])]["upgrades"][int(request.form["item"])] += 1
    hosted[int(request.form["hostedindex"])] = upgrade
